...
const HealthFoodTopics = () => {
    ...
    const fetchHealthFoodData = async () => {
      try {
        ...
        if (foodResponse.ok) {
          ...
          // Fallback: use health articles for food if not available
          if (healthResponse.ok) {
            const healthData = await healthResponse.json();
            setFoodArticles(healthData);
          }
        }
        ...
        console.error('Error loading health food data:', err);
        setError('Failed to load health and food topics. Please try again later.');
      } finally {
        setLoading(false);
      }
    };
  ...
  useEffect(() => {
    const currentArticles = activeTab === 'food' ? foodArticles : healthArticles;
    const filtered = filterArticlesByDate(currentArticles, selectedFilter);
    setFilteredArticles(filtered);
  }, [healthArticles, foodArticles, activeTab, selectedFilter]);
  ...
  const getThumbnail = (index) => {
    const thumbnails = [
      'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1538681105587-85640961bf8b?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1566554273541-37a9ca77b91b?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=60&h=45&fit=crop',
      'https://images.unsplash.com/photo-1547592180-85f173990554?w=60&h=45&fit=crop',
    ...
    return (
      <div className={`min-h-screen ${themeClasses.pageBackground} flex items-center justify-center`}>
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h2 className={`text-2xl font-bold ${themeClasses.textPrimary} mb-2`}>Unable to Load Health & Food Topics</h2>
    ...
    <div className={`min-h-screen ${themeClasses.pageBackground}`}>
      ...
      <div className="max-w-5xl-plus mx-auto px-8 pb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8">
          ...
          {/* Health Food Topics Section - 70% width */}
          <div className="lg:col-span-7 -mt-1">
            {/* Health Food Topics Section Header - Sticky with filter and bottom border */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              {filteredArticles.length > 0 ? (
                filteredArticles.map((article) => (
                  ...
                  >
                    <div className="flex items-start space-x-3 text-left pr-3">
                      <img
                        src={article.image_url || 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=300&h=200&fit=crop'}
                        alt={article.title}
                ...
                <div className="col-span-2 text-center py-12">
                  <div className="text-6xl mb-4">{activeTab === 'food' ? '🍎' : '🏥'}</div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No {activeTab === 'food' ? 'Food' : 'Health'} Topics Found</h3>
                  <p className="text-gray-600 mb-4">
                    No {activeTab === 'food' ? 'food' : 'health'} articles are available for the selected time period.
                  </p>
...
export default HealthFoodTopics;