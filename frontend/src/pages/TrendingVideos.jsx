...
const TrendingVideos = () => {
  ...
  const [trendingVideosArticles, setTrendingVideosArticles] = useState([]);
    ...
    const fetchTrendingVideosData = async () => {
      try {
        ...
        if (bollywoodResponse.ok) {
          ...
          // Fallback: use trending videos articles for bollywood if not available
          const trendingVideosData = await trendingVideosResponse.json();
          setBollywoodArticles(trendingVideosData);
        }
        ...
        console.error('Error loading trending videos data:', err);
  ...
  const getThumbnail = (index) => {
    const thumbnails = [
      ...
      'https://images.unsplash.com/photo-1606041011872-7d8de6f639d3?w=60&h=45&fit=crop',
    ...
    return (
      <div className={`min-h-screen ${themeClasses.pageBackground} flex items-center justify-center`}>
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h2 className={`text-2xl font-bold ${themeClasses.textPrimary} mb-2`}>Unable to Load Trending Videos</h2>
    ...
    <div className={`min-h-screen ${themeClasses.pageBackground}`}>
      ...
      <div className="max-w-5xl-plus mx-auto px-8 pb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8">
          ...
          {/* Trending Videos Section - 70% width */}
          <div className="lg:col-span-7 -mt-1">
            {/* Trending Videos Section Header - Sticky with filter and bottom border */}
              ...
              <div className="pl-0 pr-4 py-4">
                <div className="mb-2">
                  ...
                  <div className="flex space-x-4">
                    <button
                      onClick={() => setActiveTab('trending-videos')}
                      className={`text-base font-bold transition-colors duration-200 ${
                        activeTab === 'trending-videos'
                          ? 'text-black'
